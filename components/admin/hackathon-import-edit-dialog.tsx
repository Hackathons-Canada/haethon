        ...
        <div className="mt-5 grid gap-6 lg:grid-cols-[minmax(0,18rem)_minmax(0,1fr)]">
          ...
          <form onSubmit={saveChanges}>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <button
                className="inline-flex min-h-10 items-center gap-2 rounded-full bg-cabernet px-5 text-sm font-semibold text-wheat hover:bg-[#5c151c] dark:bg-wheat dark:text-[#141414] dark:hover:bg-white"
                type="submit"
              >
                Apply to card
              </button>
